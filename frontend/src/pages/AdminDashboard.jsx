...
const AdminDashboard = () => {
  ...
  if (error)
    return (
      <div className="text-red-600 dark:text-red-400 text-center pt-20">
        {error}
      </div>
    );
            ...
            <section>
              ...
              <div className="overflow-x-auto rounded-2xl border border-purple-500/20 backdrop-blur-sm">
                <table className="w-full text-sm">
                  <thead
                    className={`${isDark ? "bg-gray-900/70" : "bg-gray-100"}`}
                  >
                    <tr>
                      <th className="px-6 py-4 text-left font-medium text-purple-400">
                        ID
                      </th>
                      <th className="px-6 py-4 text-left font-medium text-purple-400">
                        商品名
                      ...
                      <tr
                        ...
                        className={`border-t ${
                          isDark
                            ...
                            : "border-gray-200 hover:bg-purple-50/30"
                        } transition-all`}
                      >
                        ...
                        <td className="px-6 py-4 text-purple-400 capitalize">
                          {product.category}
                        </td>
